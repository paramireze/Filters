...
struct FilterAlertContent: View {
    var body: some View {
        VStack(alignment: .leading) {
            ...
            NavigationLink(destination: ReferenceList(references: Array(arrayLiteral: 1), barTitle: "Filter Alert Reference")) {
                Text("View: (1)")
            }
            ...
            NavigationLink(destination: ReferenceList(references: Array(arrayLiteral: 2, 72), barTitle: "Filter Alert Reference")) {
                       Text("View: (2)(72)")
            }
        }
